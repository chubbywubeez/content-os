...
export const PRESENTATIONS_DIR = path.join(REPO_ROOT, 'data', 'presentations')
...
export const SKILL_SCORING = path.join(REPO_ROOT, 'data', 'skills', 'Vantum_Scoring_Prompt_v2.md')
export const SKILL_TRANSCRIPT_TWO = path.join(
  REPO_ROOT,
  'data',
  'skills',
  'Transcript_Clean_Two_Speaker_Interview_v1.md',
)
export const SKILL_TRANSCRIPT_THREE = path.join(
  REPO_ROOT,
  'data',
  'skills',
  'Transcript_Clean_Three_Speaker_Demo_v1.md',
)
export const PERSONAS_DIR = path.join(REPO_ROOT, 'data', 'os', 'Customer Personas')
